...
/* reading the proj properties, cofig.prop values using this class-PropertyReader
    ...
    */
    ...
    public static synchronized PropertyReader getInstance() {
        //this will create the object first and then read whatever property name is given
